...
My work has quite an interdisciplinary flavor, mixing quantitative and qualitative research. It includes empirical studies, data creation, algorithm/interface/system design, and evaluation---making a cohesive cycle. My work is inspired by researchers from design, philosophy, social sciences, and  practitioners from a variety of societal domains. In the past, I have worked with engineers, biologists, doctors, librarians, lawyers, etc. Seeing others use my work marks some of the most exciting moments in my research.
